...
export function HackathonSection() {
  return (
    <section id="hackathon" className="py-24 px-6 bg-[#001929]">
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-6">
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-[#002340] rounded-2xl p-8 border border-transparent hover:border-[#FF72AA]/20 transition-all"
          >
            ...
            <div className="space-y-4">
              <div>
                <div className="flex items-center gap-2 text-[#FF72AA] mb-2">
          ...
          >
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-[#FF72AA] mb-2">Program Benefits:</h3>
                <ul className="space-y-2 text-gray-400 text-sm">
